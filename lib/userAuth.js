...
export async function updateWishList(item, remove) {
...
export async function updateCart(item, remove,amount) {
    ...
    if (user) {
        ...
        if (!user.shoppingCart.includes(item)) {
            ...
            if (signedIn) {
                console.log("remove !==  true" ,remove !==  true);
                if (remove !== true ){
                    await addToShoppingCart(user.email, item);
                    console.log("update user shopping cart");
                }else {
                    console.log("removing from user shopping cart");
