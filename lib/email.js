...
export async function orderConfirmation(order){
    ...
    var deliveryAddress = `${billing.firstName} ${billing.lastName}\n`
    
    if(billing.unit == null || billing.unit == "" || typeof billing.unit === 'undefined'){
        deliveryAddress += ``
    }
...
Delivery to:
    ...
    ${billing.address} ${billing.unit}, ${billing.zip}
...
Total = $ ${order.line_items[0].amount}
